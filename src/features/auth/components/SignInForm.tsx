      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-white shadow-2xl dark:bg-gray-800 p-8 sm:p-10">
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">Inicia sesión en tu cuenta para continuar</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/reset-password" className="text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                  ¿Olvidaste?
                </Link>
              </div>
