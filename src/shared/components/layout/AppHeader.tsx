      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link to="/" className="lg:hidden">
            <img className="dark:hidden" src="./admin/images/logo/logo-gratex.svg" alt="Logo" />
            <img className="hidden dark:block" src="./admin/images/logo/logo-gratex-white.svg" alt="Logo" />
          </Link>
          ...
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            >
              <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M10.5113 1.15732C10.2117 0.947209 9.78825 0.947209 9.48866 1.15732L1.82199 6.53322C1.59754 6.69064 1.46484 6.94539 1.46484 7.21774V16.875C1.46484 17.4963 1.96855 18 2.58984 18H17.4102C18.0314 18 18.5352 17.4963 18.5352 16.875V7.21774C18.5352 6.94539 18.4025 6.69064 18.178 6.53322L10.5113 1.15732ZM3.13151 7.6111V16.3333H7.81055V11.2222H12.1895V16.3333H16.8685V7.6111L10 2.79412L3.13151 7.6111Z" fill="currentColor" />
              </svg>
              <span>Ver Sitio</span>
            </a>
            <ThemeToggle />
